...
3. Bump the version in the version file - `lib/hammer_cli_foreman_templates/version.rb`
...
When the tag is pushed to git, [the release workflow](.github/workflows/release.yml) should get triggered and should build the gem and push it to [rubygems.org](https://rubygems.org/gems/hammer_cli_foreman_templates).
